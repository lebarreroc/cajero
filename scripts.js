...
function login() {
    ...
    // Por ahora, simplemente redireccionamos al usuario a la página de inicio si los campos no están vacíos.
    var username = document.getElementById("username").value;
    var password = document.getElementById("password").value;
    
    if (username !== "" && password !== "") {
        // Simulamos una redirección a la página de inicio (index.html).
